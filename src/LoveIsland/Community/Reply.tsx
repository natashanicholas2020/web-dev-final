...
//   datetime: string;
//   replies: ReplyType[];
//   likes?: number; // optional initial likes count, if you want to expand backend later
// };
...
//       // Undo thumbs down
//       setReaction(null);
//       setLikesCount((count) => count + 1); // undo decrease
//     } else if (reaction === "up") {
...
//   return (
//     <div className="post-card" style={{ position: "relative", paddingBottom: "2.5rem" }}>
//       <p>
...
//           className={`reaction-button ${reaction === "up" ? "active" : ""}`}
//           type="button"
//         >
//           <FaThumbsUp />
//         </button>
...
//           className={`reaction-button ${reaction === "down" ? "active" : ""}`}
//           type="button"
//         >
//           <FaThumbsDown />
//         </button>
